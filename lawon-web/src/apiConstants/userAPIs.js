...
// const baseURL = 'http://192.168.18.195:3000/'
...
const getSubCategories = '/subCategories?CategoryId=' 
...
export const userAPIs = { 
    ...
    mobileVerification(paramData) {    
     ...
     // Api call for Lawyer Profile
     getLawyerProfile(paramData) {      
        console.log('paramdata is',paramData)
        const getLawyerProfileEndPoint = baseURL+getLawyerProfile+paramData;
    ...
    userForgotPassword(paramData) {      
        console.log('paramdata is',paramData)
        const userForgotPasswordEndPoint = baseURL+userForgotPassword;
