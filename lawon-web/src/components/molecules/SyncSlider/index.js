...
class SyncSlider extends Component {
  ...
  <div><img className='' src = {require('../../assets/img/Signing-a-form.png')} /></div>
            ...
            <section className='forlawyer-banner-section smartWay smartWay2'>
              ...
              <a className="universalBtn" href="javascript:void(0);">SIGN UP</a>
             </div>
                </div>
                    </div>
                </div>
            ...
            <div className="manageConsultationBox">
              ...
              <p className="" >We know that consultations can be a time-consuming process, leaving you playing catch up for the rest of your day. We want to change this. With LawOn, free consultations via phone or video call are restricted to 20 minutes, saving you valuable time. Take control of your consultations and meet the increased demand for legal advice with flexible appointments to suit you.</p>
             
            </div>
            </div>
            <div className='col-sm-5'>
            <img className='' src = {require('../../assets/img/manageConsultation.png')} />
            </div>
                       </div>
                </div>
            </section>
          ...
          <div class="col-sm-7">
              ...
              <ul id="tabs" class="nav nav-tabs tabs-right" role="tablist">
                <li role="presentation" class="">
                  <a onMouseOver={() => {
     this.openTab(1)
}} className='tablinks' href="#all" role="tab" data-toggle="tab" aria-expanded="true">
                ...
                <li role="presentation" class="">
                  ...
                  onMouseOver={() => {
                    this.openTab(2)
               }} className='tablinks' href="#online" role="tab" data-toggle="tab" aria-expanded="false">
                ...
                <li role="presentation" class="">
                  <a onMouseOver={() => {
     this.openTab(3)
}} className='tablinks' href="#offline" role="tab" data-toggle="tab" aria-expanded="false">
